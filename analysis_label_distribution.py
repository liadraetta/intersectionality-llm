...
def main():
    ...
    for model_name in model_names:
        ...
        for cot_name in cot_names:
            ...
            output_plot_path_cohen = pathlib.Path(f'results/statistical_analysis/ablation_label_distribution/cohen/{model_name}_{cot_name}.png')
            output_plot_path_match_perc = pathlib.Path(f'results/statistical_analysis/ablation_label_distribution/match_perc/{model_name}_{cot_name}.png')
            output_plot_path_combined_metrics = pathlib.Path(f'results/statistical_analysis/ablation_label_distribution/combined_metrics/{model_name}_{cot_name}.png')
    ...
    combined_output_path_cohen = pathlib.Path('results/statistical_analysis/ablation_label_distribution/cohen/all_models_combined_noCoT.png')
    combined_output_path_match_perc = pathlib.Path('results/statistical_analysis/ablation_label_distribution/match_perc/all_models_combined_noCoT.png')
    combined_output_path_metrics = pathlib.Path('results/statistical_analysis/ablation_label_distribution/combined_metrics/all_models_combined_noCoT.png')
