...
baseline = pd.read_csv("predictions/cleaned/cleaned_predictions_Llama_noCoT_baseline.csv")
...
# ---------------------------
dir = "predictions_dem/Llama/cleaned"
...
for file in glob(os.path.join(dir, file_pattern)):
    ...
    if filter_type == "positive":
        ...
        path = "output_expl_analysis/positive"
    elif filter_type == "negative":
        demographics = demographics[demographics["prediction"] == 0]
        path = "output_expl_analysis/negative"
    elif filter_type == "overall":
        path = "output_expl_analysis/overall"
    else: 
